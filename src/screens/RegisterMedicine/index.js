...
export const RegisterMedicine = () => {
    ...
    const submitHandler = async () => {
        ...
        const response = await useService(medicineService, "createMedicine", [data]);
            ...
            <View style={defaultStyles.page}>
                ...
                >
                    <View style={defaultStyles.content}>
                        ...
                        <Text style={defaultStyles.inputTopText}>Nome do medicamento</Text>
                        <TextInput
                            ...
                            value={nameMedicine}
                        />
                        <Text style={defaultStyles.inputTopText}>Data do medicamento</Text>
                        <TextInput
                            style={defaultStyles.input}
